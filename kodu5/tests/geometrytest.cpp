...
int main (int argc, char* argv[]) {
	...
	Point2 v3 {5.0, 4.0}; // c++11 
	TEST2("Point2 konstruktor v2(1,-1)", v3.x, 5, v3.y, 4);
	Point2 v4 {-1.0, -2.0}; // c++11 
	TEST2("Point2 konstruktor v2(1,-1)", v4.x, -1, v4.y, -2);
